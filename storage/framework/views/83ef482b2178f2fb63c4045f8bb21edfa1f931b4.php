        ...
        <div class="col-12 mx-auto">
            ...
            <div class="row row-cols-4 gap-5 justify-content-center">
                <div class="card col p-0">
                    <img src="<?php echo e(asset('img/fab.png')); ?>" class="card-img-top" alt="...">
                    <div class="card-body">
...
</div><?php /**PATH C:\projects\csdc105\shop\resources\views/components/product-list.blade.php ENDPATH**/ ?>